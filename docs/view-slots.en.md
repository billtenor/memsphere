...
The Catalog defines fourteen long-term Slots. `header.account` is Core-reserved and `home.modules` is generated by the composition runtime. The other twelve classes may be declared by interface extension packages and appear in the Interface configuration table. Add future Slots to both this catalog and the settings catalog.
