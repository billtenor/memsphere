...
const zh: Readonly<Record<string, string>> = Object.freeze({
  ...
  record: "本轮汇总", saveDraft: "保存草稿", savedOpinion: "已保存意见", conflict: "评审已变化，请刷新后重试。",
...
class RunApplication {
  ...
  #reviewEditor(context:Json,runId:string):HTMLElement{
    ...
    for(const comment of draft.comments||[])editor.append(commentCard(comment,tr(this.#config,"savedOpinion")));
