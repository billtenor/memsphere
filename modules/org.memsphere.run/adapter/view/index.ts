...
const styles = `
  ...
  .artifact-review-select{width:100%;min-width:0;align-items:center;color:var(--text);text-align:left;cursor:pointer}.artifact-review-select:hover{border-color:#aeb8b4}.artifact-review-select:focus-visible,.artifact-review-select[aria-expanded=true]{outline:0;border-color:var(--accent);box-shadow:0 0 0 2px #dfeeea}.artifact-review-select-caret{flex:0 0 auto;color:var(--muted);font-size:13px;line-height:1}.artifact-review-select-menu{right:0;z-index:30;display:grid;gap:2px;max-width:none;max-height:240px;overflow-y:auto}.artifact-review-select-menu[hidden]{display:none}.artifact-review-select-option{color:var(--text)}.artifact-review-select-option:hover,.artifact-review-select-option:focus-visible{outline:0;background:var(--soft)}.artifact-review-select-option[aria-selected=true]{background:#dfeeea;color:#173f3c;font-weight:700}.artifact-review-material-select{width:min(100%,520px)}.artifact-review-actor-select{width:min(100%,280px)}.artifact-review-attempt-select{width:min(100%,260px)}
  .artifact-review-vote{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.artifact-review-vote .run-btn{min-width:0;padding:7px 5px;background:var(--surface);color:var(--text)}.artifact-review-vote .run-btn.active{border-color:var(--accent);background:#dfeeea;color:#173f3c;font-weight:700}.artifact-review-vote .run-btn:focus-visible{outline:2px solid var(--accent);outline-offset:2px}
